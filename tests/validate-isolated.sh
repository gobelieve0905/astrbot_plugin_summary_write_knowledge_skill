...
trap cleanup EXIT
cd "$plugin_root"
COPYFILE_DISABLE=1 tar --no-xattrs -cf - main.py receipts.py models.py prompts.py backend.py store.py service.py directory.py sources.py native_skills.py skill_install.py tests | ssh "$server" "tar -xf - -C '$stage'"
